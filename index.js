...
if (randomDarkSideLightSide === 'Dark Side') {
  switch (randomTril) {
    ...
    case 'Orginal':
      switch (randomMessageNum) {
        case 1:
          ...
          break;
        case 2:
            message = 'If this is a consular ship, where is the ambassador? — Commander, tear this ship apart until you’ve found those plans. And bring me the passengers, I want them alive!';
          break;
        case 3:
        ...
        case 4:
          ...
          break;
        case 5:
            message = 'You are part of the Rebel Alliance and a traitor. Take her away!';
          break;
      }
      break;
    ...
    case 'Sequel':
      switch (randomMessageNum) {
        case 1:
            message ='I Know What I Have To Do, But I Don\'t Know If I Have The Strength To Do It.';
          break;
        case 2:
        ...
        case 4:
          ...
          break;
        case 5:
            message = 'Show Me, Grandfather. And I Will Finish What You Started.';
          break;
      }
      break;
  }
    ...
    case 'Orginal':
      switch (randomMessageNum) {
        case 1:
          ...
          break;
        case 2:
            message = 'Mos Eisley spaceport. You will never find a more wretched hive of scum and villainy.'
          break;
        case 3:
